...
describe('Options Concern', function (): void {
    describe('Happy Paths', function (): void {
        ...
        describe('String options with custom formatting', function (): void {
            test('returns custom formatted string from backed enum', function (): void {
                // Arrange
                $formatter = fn (string $name, $value): string => sprintf('%s => %s', $name, $value);
    ...
    describe('Edge Cases', function (): void {
        test('returns empty string for enum with no cases', function (): void {
            // Arrange & Act
            $result = EmptyEnum::stringOptions();
